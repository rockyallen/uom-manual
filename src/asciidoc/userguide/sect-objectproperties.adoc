...
The 'might' is a fairly strong suggestion that the method should probably not be used, although in fact the example Quantitys are considered equal in {product}.
...
ED: I am at my Java limits here, and making it up

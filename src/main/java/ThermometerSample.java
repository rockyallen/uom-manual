...
public class ThermometerSample implements Serializable {
    ...
    /** Stores time in whole seconds, but only visible to clients as a Quantity<Time>. Good for up to 68 years? */
    private int time; // 4 bytes
    /** Stores temperature in Kelvin,  but only visible to clients as a Quantity<Temperature> */
